...
export const Button = forwardRef<HTMLButtonElement, ButtonProps1>(
  (props, forwardedRef) => {
...
export const ButtonA = forwardRef<HTMLAnchorElement, ButtonProps2>(
  (props, forwardedRef) => {
    const { buttonProps, buttonRef: ref } = useButton({
      props,
      elementType: "a",
      forwardedRef,
    });
