...
export const Button = forwardRef<HTMLButtonElement, ButtonProps1>((props, forwardedRef) => {
  const { buttonProps, buttonRef } = useButton<HTMLAttributesButton, HTMLButtonElement>({ props, elementType: "button", forwardedRef });
...
export const ButtonA = forwardRef<HTMLAnchorElement, ButtonProps2>((props, forwardedRef) => {
  const { buttonProps, buttonRef: ref } = useButton<HTMLAttributesAnchor, HTMLAnchorElement>({ props, elementType: "a", forwardedRef });
