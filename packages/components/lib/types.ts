...
export type Sys42ComponentProps<
  Attributes = React.AllHTMLAttributes<HTMLElement>,
> = Attributes;
...
export type Sys42UnstyledComponentProps<
  ComponentProps,
  ClassMap,
  InternalComponents = void,
> = InternalComponents extends void
  ? ComponentProps & {
      styles: ClassMap;
    }
  : ComponentProps & {
