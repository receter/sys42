const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./_virtual_cosmos-imports-Dy4Hr5Rl.js","./_virtual_cosmos-imports-BU1IQdwW.css"])))=>i.map(i=>d[i]);
...
async function mount() {
  const args = await __vitePreload(() => import("./_virtual_cosmos-imports-Dy4Hr5Rl.js"), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url);
